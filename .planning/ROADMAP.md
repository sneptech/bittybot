...
Plans:
- [x] 01-01-PLAN.md -- Flutter project scaffold, platform toolchain (NDK r28+, iOS physical device), and 70+ language test corpus
- [x] 01-02-PLAN.md -- LLM-as-judge tooling (Claude Sonnet 4.6 quick check, Gemini Flash full suite, report generator)
- [x] 01-03-PLAN.md -- Model loading and token streaming integration tests (TDD)
...
- [ ] 05-02-PLAN.md -- Navigation shell (NavigationBar) + Translation screen (bubble list, input bar, typing indicator, word batching, auto-scroll)
- [ ] 05-03-PLAN.md -- Language picker bottom sheet (search, 3-column flag grid, popular/recent) + clipboard copy on bubbles
- [ ] 05-04-PLAN.md -- Human verification of complete Translation UI
...
| 5. Translation UI | 3/4 | In Progress|  |
