...
- Plan 01-05 Task 1 (Android integration tests): Partially done
  ...
  - Previously copied to `android/app/src/main/jniLibs/arm64-v8a/` — now gitignored (*.so in .gitignore)
  - .so files must be rebuilt locally before running integration tests (see next_action)
